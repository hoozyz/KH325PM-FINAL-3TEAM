        ...
        <div class="row">
            ...
            <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
              ...
              <div class="collapse d-md-block mt-3" id="account-nav">
                <div class="card-nav">
                  ...
                  <a class="card-nav-link active" href="${path}/photo/myPhoto"><i class="fi-file opacity-60 me-2"></i>나의 게시글</a>
          ...
          <div class="col-lg-8 col-md-7 mb-5">
            ...
            <ul class="nav nav-tabs border-bottom mb-4" role="tablist">
              <li class="nav-item mb-3"><a class="nav-link active" href="${path}/photo/myPhoto" role="tab" aria-selected="true"><i class="fi-image fs-base me-2"></i>포토게시판</a></li>
              <li class="nav-item mb-3"><a class="nav-link" href="${path}/board/myBoard" role="tab" aria-selected="false"><i class="fi-file fs-base me-2"></i>자유게시판</a></li>
            </ul>
            <!-- Item-->
