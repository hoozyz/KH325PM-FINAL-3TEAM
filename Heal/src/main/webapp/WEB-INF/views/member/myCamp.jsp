        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-7 mb-5">
            ...
            <ul class="nav nav-tabs border-bottom mb-4" role="tablist">
              <li class="nav-item mb-3"><a class="nav-link active" href="${path}/reserve/myCamp" role="tab" aria-selected="true"><i class="fi-calendar-alt fs-base me-2"></i>캠핑장/숙박</a></li>
              <li class="nav-item mb-3"><a class="nav-link" href="${path}/reserve/myTraffic" role="tab" aria-selected="false"><i class="fi-plane fs-base me-2"></i>교통</a></li>
            </ul>
