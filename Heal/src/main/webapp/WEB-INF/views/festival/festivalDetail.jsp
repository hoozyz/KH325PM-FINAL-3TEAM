...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="축제 상세" name="title"/>
</jsp:include>
...
<link rel="stylesheet" media="screen" href="${path}/resources/vendor/tiny-slider/dist/tiny-slider.css" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-sm-5 px-4">
                      ...
                      <option value="1">1점</option>
                            ...
                            <div class="mb-4">
                                <label class="form-label" for="review-text">축제후기 <span class='text-danger'>*</span></label>
                                <textarea class="form-control" id="review-text" rows="5" placeholder="축제 어떠셨나요?" required></textarea>
        ...
        <section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
            ...
            <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">울산고래축제</li>
                </ol>
            </nav>
                        ...
                        <div class="order-lg-1 order-2">
                            <div class="tns-carousel-wrapper">
                                ...
                                <div class="tns-carousel-inner" data-carousel-options="{&quot;navAsThumbnails&quot;: true, &quot;navContainer&quot;: &quot;#thumbnails&quot;, &quot;gutter&quot;: 12, &quot;responsive&quot;: {&quot;0&quot;:{&quot;controls&quot;: false},&quot;500&quot;:{&quot;controls&quot;: true}}}">
                                    <div><img class="rounded-3" src="${path}/resources/image/festivalDetail1.jpg" alt="Image"></div>
                                    <div><img class="rounded-3" src="${path}/resources/image/festivalDetail2.jpeg" alt="Image"></div>
                                    <div><img class="rounded-3" src="${path}/resources/image/festivalDetail3.jpg" alt="Image"></div>
                                    <div><img class="rounded-3" src="${path}/resources/image/festivalDetail4.jpg" alt="Image"></div>
                                    <div><img class="rounded-3" src="${path}/resources/image/festivalDetail5.jpg" alt="Image"></div>
                                </div>
                            </div>
                            <!-- Thumbnails nav-->
                            <ul class="tns-thumbnails mb-4" id="thumbnails">
                                <li class="tns-thumbnail"><img src="${path}/resources/image/festivalDetail1.jpg" alt="Thumbnail"></li>
                                <li class="tns-thumbnail"><img src="${path}/resources/image/festivalDetail2.jpeg" alt="Thumbnail"></li>
                                <li class="tns-thumbnail"><img src="${path}/resources/image/festivalDetail3.jpg" alt="Thumbnail"></li>
                                <li class="tns-thumbnail"><img src="${path}/resources/image/festivalDetail4.jpg" alt="Thumbnail"></li>
                                <li class="tns-thumbnail"><img src="${path}/resources/image/festivalDetail5.jpg" alt="Thumbnail"></li>
                            </ul>
                        </div>
                    </div>
                    <br>
                ...
                <aside class="col-lg-5">
                    <div class="ps-lg-5">
                        ...
                        <div class="card border-0 bg-secondary mb-4">
                            <div class="card-body">
                                <ul class="list-unstyled mt-n2 mb-0">
                                    <li class="mt-2 mb-0"><b>개최시기 | </b>2022-10-13 ~ 2022-10-16</li>
                                    <li class="mt-2 mb-0"><b>주소 | </b>울산광역시 남구 장생포고래로 244</li>
                                    <li class="mt-2 mb-0"><b>장소 | </b>장생포 고래문화특구 일원</li>
                                    <li class="mt-2 mb-0"><b>홈페이지 | </b><a href="http://www.ulsanwhale.com">http://www.ulsanwhale.com</a></li>
                                    <li class="mt-2 mb-0"><b>전화번호 | </b>052-226-1999</li>
                                    <li class="mt-2 mb-0"><b>내용 | </b>고래문화를 계승하고 보전하기 위해, 고래의 본고장 울산에서 열리는 힐링 페스티벌</li>
                                </ul>
                            </div>
                        </div>
                        <!--Map-->
                        ...
                        <script>
                            ...
                            var options = {
                                center: new kakao.maps.LatLng(35.5027537, 129.3807899593),
                                level: 3
                            };

                            var map = new kakao.maps.Map(container, options);

                            var markerPosition = new kakao.maps.LatLng(35.5027537, 129.3807899593);
        ...
        <section class="container mb-5 pb-2 pb-lg-4">
            <div>
                ...
                <h2 class="h3 mb-sm-0" style="display:inline; color: #F7B202;"> 숙소</h2>
            </div>
                ...
                <div class="tns-carousel-inner row gx-4 mx-0 pt-3 pb-4" data-carousel-options="{&quot;items&quot;: 4, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;500&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;992&quot;:{&quot;items&quot;:4}}}">
                    ...
                    <div class="col">
                        <div class="card shadow-sm card-hover border-0 h-100">
                            ...
                            <div class="card-body position-relative pb-3">
                                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">나디아</a></h3>
                                <p class="mb-2 fs-sm text-muted">울산광역시 울주군 온산읍 강양리 63</p>
                                <div class="fw-bold"><i class="fi-cash mt-n1 me-2 lead align-middle opacity-70"></i>240000원</div>
                            </div>
                        </div>
                    </div>
                    <!-- Item-->
                    <div class="col">
                        <div class="card shadow-sm card-hover border-0 h-100">
                            ...
                            <div class="card-body position-relative pb-3">
                                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">루디아</a></h3>
                                <p class="mb-2 fs-sm text-muted">울산광역시 울주군 온산읍 강양리 63</p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm card-hover border-0 h-100">
                            ...
                            <div class="card-body position-relative pb-3">
                                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">배내골 걸리버 펜션</a></h3>
                                <p class="mb-2 fs-sm text-muted">울산광역시 울주군 상북면 이천리 642</p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm card-hover border-0 h-100">
                            ...
                            <div class="card-body position-relative pb-3">
                                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">퀸즈파크펜션</a></h3>
                                <p class="mb-2 fs-sm text-muted">울산광역시 울주군 상북면 이천리 520</p>
                                <div class="fw-bold"><i class="fi-cash mt-n1 me-2 lead align-middle opacity-70"></i>120000원</div>
                            </div>
                        </div>
                    </div>
                    <!-- Item-->
                    <div class="col">
                        <div class="card shadow-sm card-hover border-0 h-100">
                            <div class="card-img-top card-img-hover">
                                ...
                                <div class="content-overlay end-0 top-0 pt-3 pe-3">
                                    <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Wishlist"><i class="fi-heart"></i></button>
                                </div><img src="${path}/resources/image/nearHotel5.jpg" alt="Image">
                            </div>
                            <div class="card-body position-relative pb-3">
                                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">하얀등대</a></h3>
                                <p class="mb-2 fs-sm text-muted">울산광역시 울주군 서생면 대송리 25</p>
                                <div class="fw-bold"><i class="fi-cash mt-n1 me-2 lead align-middle opacity-70"></i>210000원</div>
                            </div>
                        </div>
                    </div>
