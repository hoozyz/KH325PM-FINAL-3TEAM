                ...
                <div class="modal-content">
                    ...
                    <option value="1">1점</option>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="cont" id="review-text" rows="5" placeholder="축제는 어떠셨나요?" required></textarea>
                                <div class="invalid-feedback">축제후기를 등록해주세요</div>
                            </div>
                ...
                <aside class="col-lg-5">
                    <div class="ps-lg-5">
                        ...
                        <div class="card border-0 bg-secondary mb-4">
                            <div class="card-body">
                                <ul class="list-unstyled mt-n2 mb-0">
                                    ...
                                    <li class="mt-2 mb-0"><b>주소 | </b>${festival.addr}</li>
                                    <li class="mt-2 mb-0"><b>장소 | </b>${festival.place}</li>
                                    <c:if test="${!empty festival.homepage}">
                                   		<li class="mt-2 mb-0"><b>홈페이지 | </b><a href="${festival.homepage}">${festival.homepage}</a></li>
                                    </c:if>
                                    <li class="mt-2 mb-0"><b>전화번호 | </b>${festival.phone}</li>
                                    <li class="mt-2 mb-0"><b>내용 | </b>${festival.cont}</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            var options = {
                                center: new kakao.maps.LatLng('${festival.lat}', '${festival.lng}'),
                                level: 3
                            };
                        ...
                        <div style="margin-bottom:30px;">
	                    	<p id="weaStr" style="float: left; color: black; font-weight:600;">현재 축제의 날씨는?</p>
